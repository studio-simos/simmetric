 ...
 * embeddings.test.ts discipline). The real `ollama` package is deliberately
 * NOT mocked: construction is side-effect-free, and the real import doubles
 * as a jest-runtime (@swc/jest CJS transform) resolution check.
 */
...
describe("getOllamaClient (92-01 D-02)", () => {
