...
function App() {
  ...
  // Default accent = the committed sienna (matches --primary in index.css and
  // the seed's BRANDING_PRIMARY_COLOR) so the pre-branding flash renders the
  // brand world, not the retired indigo.
  const [primaryColor, setPrimaryColor] = useState("#973C00");
